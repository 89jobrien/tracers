//! `trace-agent` — the `Agent` trait, `spawn`/`delegate`, and lifecycle
...
//! use trace_agent::{Agent, AgentContext, spawn};
//! use trace_core::{Trace, Step};
//!
//! struct Greeter;
//!
//! #[async_trait]
...
pub use spawn::{delegate, spawn, SpawnOutcome};
